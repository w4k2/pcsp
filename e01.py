...
def main():
    for ds_name in datasets:
        ...
        estimators = [
            PCSKMeans(n_clusters=n_clusters, init='k-means++', random_state=100),
            COPKMeans(n_clusters=n_clusters, init='k-means++', random_state=100),
            MiniBatchCOPKmeans(n_clusters=n_clusters, init='k-means++', random_state=100),
        ]
